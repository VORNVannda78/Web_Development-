import { MapPin, CheckCircle, Clock, Package, DollarSign } from "lucide-react";
...
const deliveryHistory = [
  ...
  { id: "ORD015", restaurant: "Bai Cha House", address: "Russian Market, Phnom Penh", amount: 0, status: "Cancelled", time: "12:30 PM", distance: "1.8 km" },
  ...
  return (
    <div className="pb-4">
      ...
      <div className="px-4 pt-4">
        <div className="bg-gradient-to-r from-amber-400 to-orange-500 rounded-2xl p-4 text-white mb-4 grid grid-cols-3 gap-3">
